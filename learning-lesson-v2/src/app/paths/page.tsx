...
export default async function PathsPage() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-8">
      <div>
        <p className="text-sm font-bold uppercase text-mint">Learning paths</p>
        <h1 className="mt-2 text-4xl font-black">Choose a path</h1>
        <p className="mt-3 max-w-2xl text-ink/70">
          Each path unlocks one lesson at a time. Later we can replace this local blueprint with Supabase lesson rows.
        </p>
      </div>
