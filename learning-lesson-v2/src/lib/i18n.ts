...
export const dictionary = {
  bg: {
    ...
    paths: {
      ...
      title: "Избери мисия",
      subtitle: "Всяка мисия отключва уроците по ред. Избери пътека и започни с първата задача.",
      level: "Ниво",
      levels: "нива",
      missions: "урока",
    ...
    lesson: {
      ...
      missionCompletionHint: "Напиши поне 12 символа решение или отключи всички 3 подсказки, за да завършиш мисията.",
  ...
  en: {
    ...
    paths: {
      ...
      subtitle: "Each path unlocks one lesson at a time. Pick a quest and start with the first mission.",
      level: "Level",
      levels: "levels",
      missions: "missions",
    ...
    lesson: {
      ...
      missionCompletionHint: "Write at least 12 characters in your solution or unlock all 3 hints to complete the mission.",
