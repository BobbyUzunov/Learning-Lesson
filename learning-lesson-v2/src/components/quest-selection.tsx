        ...
        return (
          ...
          >
            <div className="flex items-start justify-between gap-3">
              ...
              <span className="rounded-md bg-mint/15 px-2 py-1 text-xs font-bold text-ink">{quest.levels} levels</span>
            </div>
            ...
            <div className="mt-4">
              <div className="flex justify-between text-sm font-bold text-ink/70">
                <span>{completed}/{quest.lessonIds.length} missions</span>
                <span>{progress}%</span>
              </div>
            ...
            >
              {hasStarted ? "Continue Quest" : "Start Quest"}
